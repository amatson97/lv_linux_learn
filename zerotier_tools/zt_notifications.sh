#!/bin/bash
# * * * * * DISPLAY=:0 DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus /home/$USER/lv_linux_learn/zerotier_tools/zt_notifications.sh ApT2ayFbk2uxhPBpG2bZSWewfcbjqFSe 8bd5124fd60a971f
