...
class ScriptMetadata:
    ...
    @staticmethod
    def _determine_source(script_path: str, category: str, script_name: str, 
                         script_id_map: dict, metadata: dict) -> Tuple[str, str]:
    ...
    @staticmethod
    def get_status_icon(metadata: Dict) -> str:
...
class ScriptExecutor:
    ...
    def build_command(
        ...
        # Build command
        executor = "bash" if not use_source else "source"
    ...
    @staticmethod
    def _get_type(script_path: str, metadata: Optional[Dict] = None) -> str:
    ...
    @staticmethod
    def _get_source_type(script_path: str, metadata: Optional[Dict] = None) -> str:
...
class ScriptNavigator:
    ...
    @staticmethod
    def should_prompt_for_download(script_path: str, metadata: Optional[Dict] = None) -> bool:
...
def build_script_metadata(script_path: str, category: str, script_name: str = "",
                         repository=None, custom_script_manager=None,
                         script_id_map: dict = None) -> Dict[str, any]:
...
def is_script_cached(repository, script_id: str = None, 
                    script_path: str = None, category: str = None) -> bool:
...
def should_use_cache_engine(metadata: Optional[Dict] = None) -> bool:
...
def build_script_command(script_path: str, metadata: Optional[Dict] = None,
                        env_vars: Optional[Dict[str, str]] = None) -> Tuple[str, str]:
